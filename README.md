...
Info on how to test PatientMatcher or to set up a server containing an app frontend and backend is available on the [documentation page](https://clinical-genomics.github.io/patientMatcher).

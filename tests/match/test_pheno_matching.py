...
def test_phenotype_matching(json_patients, database, demo_data_path):
    ...
    matches_HPO_OMIM = match(database, 0.5, formatted_patient['features'],  formatted_patient['disorders'])
    ...
    matches_OMIM = match(database, 0.5, formatted_patient['features'],  formatted_patient['disorders'])
    ...
    matches_no_phenotypes = match(database, 0.5, formatted_patient['features'],  formatted_patient['disorders'])
    ...
    matches_HPO = match(database, 0.5, formatted_patient['features'],  formatted_patient['disorders'])
